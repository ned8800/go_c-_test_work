...
var file_proto_subpub_proto_rawDesc = []byte{
	0x0a, 0x12, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x75, 0x62, 0x70, 0x75, 0x62, 0x2e, 0x70,
...
var (
	...
	file_proto_subpub_proto_rawDescData = file_proto_subpub_proto_rawDesc
)

func file_proto_subpub_proto_rawDescGZIP() []byte {
	file_proto_subpub_proto_rawDescOnce.Do(func() {
		file_proto_subpub_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_subpub_proto_rawDescData)
	})
	return file_proto_subpub_proto_rawDescData
}

var file_proto_subpub_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_subpub_proto_goTypes = []interface{}{
...
func file_proto_subpub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_subpub_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_subpub_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_subpub_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Event); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_subpub_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_proto_subpub_proto_rawDesc = nil
